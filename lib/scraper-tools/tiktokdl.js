...
async function TiktokDownloader (url) {
    try {
        const tokenn = await axios.get("https://downvideo1.quora-wiki.com/tiktok-video-downloader?r#url=" + url);
        ...
        const { data } = await axios.request("https://downvideo1.quora-wiki.com/system/action.php", {
                ...
                headers: {
                    ...
                    "referer": "https://downvideo.quora-wiki.com/tiktok-video-downloader?r",
                },
            }
        );
        return {
